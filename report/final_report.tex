...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[x=0.55cm,y=0.55cm,>=Latex,font=\small]
    ...
    \node[draw, rounded corners=2pt, minimum width=2.6cm, minimum height=0.9cm, align=center] (rgb) at (2,4.2) {RGB\\Camera};
    \node[draw, rounded corners=2pt, minimum width=2.6cm, minimum height=0.9cm, align=center] (thermal) at (2,1.8) {Thermal\\Camera};

    % Processing and Analysis box
    \draw[rounded corners=6pt, line width=0.6pt] (6,0.5) rectangle (14,5.5);
    \node at (10,5.1) {\bfseries Processing and Analysis};
    \node[draw, rounded corners=2pt, minimum width=2.8cm, minimum height=1.0cm, align=center] (frame) at (7.5,3.8) {Frame\\Extractor};
    \node[draw, rounded corners=2pt, minimum width=3.0cm, minimum height=1.0cm, align=center] (model) at (10.0,3.8) {FireFusionNet\\AI Model};
    \node[draw, rounded corners=2pt, minimum width=2.8cm, minimum height=1.0cm, align=center] (temporal) at (12.5,3.8) {Temporal\\Analyzer};
    \node[draw, rounded corners=2pt, minimum width=3.2cm, minimum height=1.0cm, align=center] (conf) at (10.9,2.0) {Confidence\\Evaluator};
    ...
    % Verification module
    \node[draw, rounded corners=2pt, minimum width=3.2cm, minimum height=1.0cm, align=center] (verify) at (15.7,3.8) {Verification\\Module};
    \draw[->, thick] (conf.east) -- (verify.west);

    % Alerting box
    \draw[rounded corners=6pt, line width=0.6pt] (17.4,0.5) rectangle (22.8,5.5);
    \node at (20.1,5.1) {\bfseries Alerting};
    \draw[rounded corners=4pt] (18.3,1.0) rectangle (21.9,4.6);
    \node at (20.1,4.35) {\scriptsize Notification Module};
    \node[draw, rounded corners=2pt, minimum width=2.6cm, minimum height=0.8cm, align=center] at (20.1,3.5) {Email};
    \node[draw, rounded corners=2pt, minimum width=2.6cm, minimum height=0.8cm, align=center] at (20.1,2.6) {SMS};
    \node[draw, rounded corners=2pt, minimum width=2.6cm, minimum height=0.8cm, align=center] at (20.1,1.7) {WhatsApp};
    \draw[->, thick] (verify.east) -- (17.4,3.8);
  \end{tikzpicture}
