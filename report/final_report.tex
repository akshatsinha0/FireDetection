...
\begin{figure}[h]
  \centering
\begin{tikzpicture}[x=0.5cm,y=0.5cm,>=Latex,font=\small]
    % Data Acquisition box
    \draw[rounded corners=6pt, line width=0.6pt] (0,0) rectangle (5,7);
    \node[font=\bfseries] at (2.5,6.4) {Data Acquisition};
    \node[draw, rounded corners=2pt, minimum width=3.0cm, minimum height=1.2cm, align=center] (rgb) at (2.5,4.7) {RGB\\Camera};
    \node[draw, rounded corners=2pt, minimum width=3.0cm, minimum height=1.2cm, align=center] (thermal) at (2.5,2.3) {Thermal\\Camera};

    % Processing and Analysis box
    \draw[rounded corners=6pt, line width=0.6pt] (6,0.8) rectangle (19,6.2);
    \node[font=\bfseries] at (12.5,5.9) {Processing and Analysis};
    \node[draw, rounded corners=2pt, minimum width=3.6cm, minimum height=1.1cm, align=center] (frame) at (8.5,4.4) {Frame\\Extractor};
    \node[draw, rounded corners=2pt, minimum width=3.8cm, minimum height=1.1cm, align=center] (model) at (12.2,4.4) {FireFusionNet\\AI Model};
    \node[draw, rounded corners=2pt, minimum width=3.6cm, minimum height=1.1cm, align=center] (temporal) at (15.8,4.4) {Temporal\\Analyzer};
    \node[draw, rounded corners=2pt, minimum width=4.0cm, minimum height=1.1cm, align=center] (conf) at (12.2,2.2) {Confidence\\Evaluator};

    % Arrows from cameras to processing
    \draw[->, thick] (5,4.7) -- (6,4.7);
    \draw[->, thick] (5,2.3) .. controls (5.6,2.4) and (6.2,3.2) .. (6.8,4.2);
    ...
    % Verification module
    \node[draw, rounded corners=2pt, minimum width=3.6cm, minimum height=1.1cm, align=center] (verify) at (21,4.4) {Verification\\Module};
    \draw[->, thick] (conf.east) -- (verify.west);

    % Alerting box
    \draw[rounded corners=6pt, line width=0.6pt] (22.8,0.8) rectangle (29,6.2);
    \node[font=\bfseries] at (25.9,5.9) {Alerting};
    \draw[rounded corners=4pt] (23.6,1.4) rectangle (28.2,5.2);
    \node at (25.9,5.2) {\scriptsize Notification Module};
    \node[draw, rounded corners=2pt, minimum width=3.0cm, minimum height=0.9cm, align=center] at (25.9,4.3) {Email};
    \node[draw, rounded corners=2pt, minimum width=3.0cm, minimum height=0.9cm, align=center] at (25.9,3.3) {SMS};
    \node[draw, rounded corners=2pt, minimum width=3.0cm, minimum height=0.9cm, align=center] at (25.9,2.3) {WhatsApp};
    \draw[->, thick] (verify.east) -- (22.8,4.4);
  \end{tikzpicture}
