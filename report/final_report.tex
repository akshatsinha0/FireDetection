...
\begin{figure}[h]
  \centering
\begin{tikzpicture}[x=0.37cm,y=0.37cm,>=Latex,font=\small,xshift=-0.4cm]
    ...
    % Processing and Analysis block (single pipeline, no individual boxes)
    ...
    % Single pipeline arrow through processing block with labels (no boxes)
    \draw[->, thick] (9,5.6) -- (27,5.6);
    \node at (12.5,6.2) {Frame Extractor};
    \node at (17.5,6.2) {FireFusionNet};
    \node at (22.5,6.2) {Temporal Analyzer};
    \node at (17.5,2.6) {Confidence\\Evaluator};
    ...
    \draw[->, thick] (22.8,3.0) .. controls (24.8,3.2) and (27.0,4.0) .. (28.9,5.0);
