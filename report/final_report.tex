...
\begin{figure}[h]
  \centering
\begin{tikzpicture}[x=0.45cm,y=0.45cm,>=Latex,font=\small]
    % Data Acquisition block
    \draw[rounded corners=6pt, line width=0.6pt] (0,0) rectangle (6,8);
    \node[font=\bfseries] at (3,8.6) {Data Acquisition};
    \node[draw, rounded corners=2pt, minimum width=3.6cm, minimum height=1.4cm, align=center] (rgb) at (3,5.6) {RGB\\Camera};
    \node[draw, rounded corners=2pt, minimum width=3.6cm, minimum height=1.4cm, align=center] (thermal) at (3,2.4) {Thermal\\Camera};

    % Processing and Analysis block
    \draw[rounded corners=6pt, line width=0.6pt] (9,0.8) rectangle (27,7.2);
    \node[font=\bfseries] at (18,7.8) {Processing and Analysis};
    \node[draw, rounded corners=2pt, minimum width=4.2cm, minimum height=1.4cm, align=center] (frame) at (12.5,5.2) {Frame\\Extractor};
    \node[draw, rounded corners=2pt, minimum width=4.6cm, minimum height=1.4cm, align=center] (model) at (17.5,5.2) {FireFusionNet\\AI Model};
    \node[draw, rounded corners=2pt, minimum width=4.2cm, minimum height=1.4cm, align=center] (temporal) at (22.5,5.2) {Temporal\\Analyzer};
    \node[draw, rounded corners=2pt, minimum width=5.0cm, minimum height=1.4cm, align=center] (conf) at (17.5,2.6) {Confidence\\Evaluator};

    % Arrows from cameras to processing (spaced)
    \draw[->, thick] (6,5.6) -- (9,5.6);
    \draw[->, thick] (6,2.4) .. controls (7.2,2.8) and (8.2,4.0) .. (9.6,5.0);
    ...
    \node[draw, rounded corners=2pt, minimum width=4.2cm, minimum height=1.4cm, align=center] (verify) at (30.5,5.2) {Verification\\Module};
    \draw[->, thick] (conf.east) .. controls (24.5,2.6) and (27.0,3.8) .. (28.4,4.8);
    \draw[->, thick] (28.4,4.8) -- (28.9,5.0);

    % Alerting block
    \draw[rounded corners=6pt, line width=0.6pt] (33,0.8) rectangle (42,7.2);
    \node[font=\bfseries] at (37.5,7.8) {Alerting};
    \draw[rounded corners=4pt] (34,1.6) rectangle (41,6.2);
    \node at (37.5,6.3) {\scriptsize Notification Module};
    \node[draw, rounded corners=2pt, minimum width=3.8cm, minimum height=1.0cm, align=center] at (37.5,4.9) {Email};
    \node[draw, rounded corners=2pt, minimum width=3.8cm, minimum height=1.0cm, align=center] at (37.5,3.7) {SMS};
    \node[draw, rounded corners=2pt, minimum width=3.8cm, minimum height=1.0cm, align=center] at (37.5,2.5) {WhatsApp};
    \draw[->, thick] (verify.east) -- (33,5.2);
  \end{tikzpicture}
